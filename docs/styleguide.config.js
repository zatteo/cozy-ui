...
module.exports = {
  ...
  sections: [
    ...
    },
    {
      ...
      components: () => [
        ...
        '../react/InputGroup',
        '../react/Label',
        '../react/NestedSelect/NestedSelect',
        '../react/Radios',
    ...
    },
    {
      name: 'Intents',
      components: () => [
        '../react/IntentIframe/IntentIframe',
        '../react/IntentDialogOpener/IntentDialogOpener'
      ]
    },
    {
      name: 'List',
    ...
    },
    {
      ...
      components: () => [
        '../react/CompositeRow',
        '../react/InlineCard',
        '../react/IntentModal/IntentModal',
        '../react/IntentOpener/IntentOpener',
        '../react/Menu',
        '../react/Modal',
  ...
  components: ['../react/**/*.jsx', '../react/**/*.tsx'],
  template: {
    head: {
      meta: [
        {
